...
| [BDR-013](decisions/BDR-013.md) | 2026-05-05 | Workflow graphify : hook post-commit retiré, mise à jour manuelle via `--update`  | actif  |
| [BDR-014](decisions/BDR-014.md) | 2026-05-05 | Stratégie versionning graphify-out : outputs committés, cache gitignored          | actif  |
