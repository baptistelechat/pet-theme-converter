...
| [BDR-019](decisions/BDR-019.md) | 2026-05-07 | Types intermédiaires Core exportés depuis leur module source (pas `types.ts`)       | actif     |
| [BDR-020](decisions/BDR-020.md) | 2026-05-07 | Messages d'erreur du pipeline Core en anglais (lib publique npm)                    | actif     |
| [BDR-021](decisions/BDR-021.md) | 2026-05-07 | Stories → `stories/epic-X/`, rétrospectives → `retrospectives/` dans impl-artifacts | actif     |
| [BDR-022](decisions/BDR-022.md) | 2026-05-07 | Mapping Codex→Clawd validé terrain : 7/9 lignes mappées, frames réels par état      | actif     |
